...
//< parser-expr if-parser
#[derive(PartialEq, Clone, Debug)]
pub enum Expression {
    LiteralExpr(f64),
    VariableExpr(String),
//> ch-1 parser-expr if-parser
...
//< ch-1 parser-parse-primary-expr if-parser
...
//> parser-parse-primary-expr if-parser
