...
//< ch-1 ch-4 parser-parse-prototype
    ...
    Good(
        Prototype {
            name: name,
            args: args, //> ch-1 ch-4 parser-parse-prototype
            /*j*/
            ftype: ftype, //< ch-1 ch-4 parser-parse-prototype
                          /*j*/
        },
        parsed_tokens,
    )
...
fn parse_expression(
    ...
    let prototype = Prototype {
        name: "".to_string(),
        args: vec![], //> ch-1 ch-4 parser-parse-expression
        ftype: Normal, //< ch-1 ch-4 parser-parse-expression
                      /*j*/
    };
    let lambda = Function {
        prototype: prototype,
